...
def _build_prompt(goal_target: str = "") -> str:
    ...
    body = (
        ...
        "- objects: ALL findable objects — list EVERY piece of furniture separately. "
        "If there are multiple sofas or couches, list EACH ONE with its own entry "
        "including its color (e.g. 'turquoise_sofa', 'dark_brown_sofa'). "
        "Name MUST include color and type (e.g. 'dark_brown_leather_sofa'). "
        "Description MUST mention color, material, and size.\n"
